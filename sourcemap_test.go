...
const (
	...
	testFileWithoutNames   = `{"version":3,"file":"min.js","sourceRoot":"/the/root","sources":["one.js","two.js"],"mappings":"CAAC,IAAI,IAAM,SAAUA,GAClB,OAAOC,IAAID;CCDb,IAAI,IAAM,SAAUE,GAClB,OAAOA"}` + "\n"
	testFileWithoutSources = `{"version":3,"file":"min.js","sourceRoot":"/the/root","names":["bar","baz","n"],"mappings":"CAAC,IAAI,IAAM,SAAUA,GAClB,OAAOC,IAAID;CCDb,IAAI,IAAM,SAAUE,GAClB,OAAOA"}`
)
